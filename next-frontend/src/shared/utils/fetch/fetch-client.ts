...
export class FetchClient {
	...
	public params?: SearchParamsType
	 ...
	 * @param {SearchParamsType} [init.params] - Параметры для поиска.
	 ...
	 *
	 * @param {SearchParamsType} params - Параметры поиска.
	 * @returns {string} - Строка параметров поиска, начинающаяся с "?".
	 */
	private createSearchParams(params: SearchParamsType) {
